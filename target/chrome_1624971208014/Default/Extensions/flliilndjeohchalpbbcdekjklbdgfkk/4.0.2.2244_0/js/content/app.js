...
},{"core-js/modules/es6.array.iterator.js":64,"core-js/modules/web.dom.iterable.js":65}],2:[function(require,module,exports){
module.exports={
...
module.exports = function init() {
  return new Promise(resolve => {
    const serp = SERP.getInstance();
    const topURL = URLClassification.getInstance();
    const pua = PUA.getInstance();
    const pStatuses = new Promise(resolve => messenger.publish('fetchTabStatuses', null, resolve));
    const pTabData = new Promise(resolve => messenger.publish('Tabs:getData', {
      classifier: 'AUCClassifier'
    }, resolve));
    /* eslint-disable-next-line no-unused-vars */

    Promise.all([pStatuses, pTabData]).then(([statuses, tabData]) => {
      resolve(!tabData.hasUnsafeContent);
    });

    const showUCWarning = ignoreAllowed => {
    ...
    const showMaliciousSearchOfferBar = () => messenger.publish('router:navigateTo', {
      route: 'maliciousSearchEngine'
    });

    pTabData.then(tabData => {
      topURL.set(tabData);
      ...
      if (topURL.get('isIFrame')) {
        pStatuses.then(statuses => {
          if (topURL.get('isMSE') && !statuses.isTrustedSearchEngine) {
            showMaliciousSearchOfferBar();
          } else if (topURL.get('hasUnsafeContent')) {
            if (!(statuses !== null && statuses !== void 0 && statuses.isUCWarningIgnored || topURL.get('hasUnsafeContentException'))) {
              showUCWarning(statuses.isUCWarningIgnoreAllowed);
            }
          } else if (!statuses.isUCWarningIgnored) {
            topURL.once('change:hasUnsafeContent', () => {
    ...
    messenger.subscribe('leavingDash', () => {
    ...
    messenger.subscribe('router:beforeRouteChange', ({
      route
    }) => {
...
},{"content/Models/PUA":116,"content/Models/SERP":117,"content/Models/URLClassification":119,"content/messagingInterface":143,"core-js/modules/es6.array.iterator.js":64,"core-js/modules/web.dom.iterable.js":65}],5:[function(require,module,exports){
...
module.exports["default"] = module.exports, module.exports.__esModule = true;
},{"./assertThisInitialized.js":5,"@babel/runtime/helpers/typeof":14}],13:[function(require,module,exports){
...
},{"backbone":17,"underscore":94}],16:[function(require,module,exports){
(function(factory) {
  if (typeof define === 'function' && define.amd) {
...
},{"backbone":17,"underscore":94}],17:[function(require,module,exports){
...
},{"jquery":"jquery","underscore":94}],18:[function(require,module,exports){
...
},{"./_hide":35,"./_wks":63}],21:[function(require,module,exports){
...
},{"./_to-absolute-index":56,"./_to-iobject":58,"./_to-length":59}],23:[function(require,module,exports){
...
},{"./_global":33,"./_is-object":39}],29:[function(require,module,exports){
...
},{"./_core":24,"./_ctx":25,"./_global":33,"./_hide":35,"./_redefine":52}],31:[function(require,module,exports){
...
},{"./_shared":55}],33:[function(require,module,exports){
...
},{"./_descriptors":27,"./_object-dp":46,"./_property-desc":51}],36:[function(require,module,exports){
var document = require('./_global').document;
...
},{"./_hide":35,"./_object-create":45,"./_property-desc":51,"./_set-to-string-tag":53,"./_wks":63}],41:[function(require,module,exports){
'use strict';
...
},{"./_export":30,"./_hide":35,"./_iter-create":40,"./_iterators":43,"./_library":44,"./_object-gpo":48,"./_redefine":52,"./_set-to-string-tag":53,"./_wks":63}],42:[function(require,module,exports){
...
},{"./_an-object":21,"./_dom-create":28,"./_enum-bug-keys":29,"./_html":36,"./_object-dps":47,"./_shared-key":54}],46:[function(require,module,exports){
var anObject = require('./_an-object');
...
},{"./_an-object":21,"./_descriptors":27,"./_ie8-dom-define":37,"./_to-primitive":61}],47:[function(require,module,exports){
var dP = require('./_object-dp');
var anObject = require('./_an-object');
...
},{"./_an-object":21,"./_descriptors":27,"./_object-dp":46,"./_object-keys":50}],48:[function(require,module,exports){
...
},{"./_has":34,"./_shared-key":54,"./_to-object":60}],49:[function(require,module,exports){
var has = require('./_has');
var toIObject = require('./_to-iobject');
...
},{"./_array-includes":22,"./_has":34,"./_shared-key":54,"./_to-iobject":58}],50:[function(require,module,exports){
...
},{"./_core":24,"./_function-to-string":32,"./_global":33,"./_has":34,"./_hide":35,"./_uid":62}],53:[function(require,module,exports){
...
},{"./_has":34,"./_object-dp":46,"./_wks":63}],54:[function(require,module,exports){
...
},{"./_core":24,"./_global":33,"./_library":44}],56:[function(require,module,exports){
...
},{"./_defined":26,"./_iobject":38}],59:[function(require,module,exports){
// 7.1.15 ToLength
var toInteger = require('./_to-integer');
var min = Math.min;
module.exports = function (it) {
...
},{"./_is-object":39}],62:[function(require,module,exports){
var id = 0;
var px = Math.random();
module.exports = function (key) {
...
},{"./_global":33,"./_shared":55,"./_uid":62}],64:[function(require,module,exports){
'use strict';
...
},{"./_add-to-unscopables":20,"./_iter-define":41,"./_iter-step":42,"./_iterators":43,"./_to-iobject":58}],65:[function(require,module,exports){
...
},{"./_global":33,"./_hide":35,"./_iterators":43,"./_object-keys":50,"./_redefine":52,"./_wks":63,"./es6.array.iterator":64}],66:[function(require,module,exports){
"use strict";

module.exports = require('./src/ContentMessenger');

},{"./src/ContentMessenger":67}],67:[function(require,module,exports){
"use strict";
...
},{"./ContentTopic":68,"./Messenger":69,"./chrome":71,"@babel/runtime/helpers/assertThisInitialized":5,"@babel/runtime/helpers/classCallCheck":6,"@babel/runtime/helpers/createClass":7,"@babel/runtime/helpers/getPrototypeOf":9,"@babel/runtime/helpers/inherits":10,"@babel/runtime/helpers/interopRequireDefault":11,"@babel/runtime/helpers/possibleConstructorReturn":12}],68:[function(require,module,exports){
"use strict";
...
},{"./Topic":70,"./chrome":71,"@babel/runtime/helpers/classCallCheck":6,"@babel/runtime/helpers/getPrototypeOf":9,"@babel/runtime/helpers/inherits":10,"@babel/runtime/helpers/interopRequireDefault":11,"@babel/runtime/helpers/possibleConstructorReturn":12}],69:[function(require,module,exports){
"use strict";
...
},{"@babel/runtime/helpers/classCallCheck":6,"@babel/runtime/helpers/createClass":7,"@babel/runtime/helpers/interopRequireDefault":11}],70:[function(require,module,exports){
"use strict";
...
},{"@babel/runtime/helpers/classCallCheck":6,"@babel/runtime/helpers/createClass":7,"@babel/runtime/helpers/interopRequireDefault":11}],71:[function(require,module,exports){
"use strict";
...
},{"./src/js/adaptor/jquery":74}],74:[function(require,module,exports){
'use strict';
...
},{"../main":79,"../plugin/instances":90}],75:[function(require,module,exports){
'use strict';
...
},{"./dom":75}],79:[function(require,module,exports){
'use strict';
...
},{"./plugin/destroy":81,"./plugin/initialize":89,"./plugin/update":93}],80:[function(require,module,exports){
'use strict';
...
},{"../lib/dom":75,"../lib/helper":78,"./instances":90}],82:[function(require,module,exports){
'use strict';
...
},{"../instances":90,"../update-geometry":91,"../update-scroll":92}],83:[function(require,module,exports){
'use strict';
...
},{"../../lib/dom":75,"../../lib/helper":78,"../instances":90,"../update-geometry":91,"../update-scroll":92}],84:[function(require,module,exports){
'use strict';
...
},{"../../lib/dom":75,"../../lib/helper":78,"../instances":90,"../update-geometry":91,"../update-scroll":92}],85:[function(require,module,exports){
'use strict';
...
},{"../instances":90,"../update-geometry":91,"../update-scroll":92}],86:[function(require,module,exports){
'use strict';
...
},{"../instances":90,"../update-geometry":91}],87:[function(require,module,exports){
'use strict';
...
},{"../../lib/helper":78,"../instances":90,"../update-geometry":91,"../update-scroll":92}],88:[function(require,module,exports){
'use strict';
...
},{"../../lib/helper":78,"../instances":90,"../update-geometry":91,"../update-scroll":92}],89:[function(require,module,exports){
'use strict';
...
},{"./handler/click-rail":82,"./handler/drag-scrollbar":83,"./handler/keyboard":84,"./handler/mouse-wheel":85,"./handler/native-scroll":86,"./handler/selection":87,"./handler/touch":88,"./instances":90,"./update-geometry":91}],90:[function(require,module,exports){
'use strict';
...
},{"../lib/dom":75,"../lib/event-manager":76,"../lib/guid":77,"../lib/helper":78,"./default-setting":80}],91:[function(require,module,exports){
'use strict';
...
},{"../lib/dom":75,"../lib/helper":78,"./instances":90,"./update-scroll":92}],92:[function(require,module,exports){
'use strict';
...
},{"./instances":90}],93:[function(require,module,exports){
'use strict';
...
},{"../lib/dom":75,"../lib/helper":78,"./instances":90,"./update-geometry":91,"./update-scroll":92}],94:[function(require,module,exports){
//     Underscore.js 1.8.3
...
},{"core-js/modules/es6.array.iterator.js":64,"core-js/modules/web.dom.iterable.js":65}],113:[function(require,module,exports){
"use strict";
...
},{"i18n/de-DE":100,"i18n/en-US":101,"i18n/es-ES":102,"i18n/fr-FR":103,"i18n/it-IT":104,"i18n/ja-JP":105,"i18n/nl-NL":106,"i18n/pt-BR":107,"i18n/ru-RU":108,"i18n/tr-TR":109,"i18n/zh-CN":110,"i18n/zh-TW":111}],114:[function(require,module,exports){
"use strict";
...
},{"background/localStorage":1,"configuration":2,"underscore":94}],115:[function(require,module,exports){
"use strict";
...
},{"content/core/Models/ModelBackground":134}],116:[function(require,module,exports){
"use strict";
...
},{"content/core/Models/ModelBackground":134,"content/messagingInterface":143}],117:[function(require,module,exports){
"use strict";
...
},{"content/core/Models/ModelBackground":134}],118:[function(require,module,exports){
"use strict";
...
},{"content/Models/PUA":116,"content/Models/SERP":117,"content/Models/URLClassification":119,"content/core/Models/ModelBackground":134,"content/messagingInterface":143,"modules/offers/content/iframe/models/Ciuvo":149}],119:[function(require,module,exports){
"use strict";
...
},{"content/core/Models/ModelBackground":134}],120:[function(require,module,exports){
"use strict";
...
},{"content/Views/BlankIndicators":124,"content/Views/MaliciousSearchEngineBar":128,"content/Views/UnsafeContentBar":132,"content/core/Routing/Router":138}],121:[function(require,module,exports){
"use strict";
...
},{"content/Transitions/Default":122,"content/Views/Dash/TabView":125,"jquery":"jquery"}],122:[function(require,module,exports){
"use strict";
...
},{"content/core/Transitions/Base":139,"content/core/Views/View":141,"jquery":"jquery"}],123:[function(require,module,exports){
"use strict";
...
},{"content/Transitions/Default":122,"content/Views/Tour/TourStepBase":131}],124:[function(require,module,exports){
"use strict";
...
},{"content/core/Views/View":141}],126:[function(require,module,exports){
"use strict";
...
},{"Indicators/Close.mustache":96,"content/Views/Indicators/Indicator":127}],127:[function(require,module,exports){
"use strict";
...
},{"content/Models/State":118,"content/core/Views/View":141}],128:[function(require,module,exports){
"use strict";
...
},{"MaliciousSearchEngineBar.mustache":97,"content/Models/URLClassification":119,"content/Views/Indicators/Close":126,"content/core/Views/View":141,"content/messagingInterface":143,"content/mixpanel":144}],129:[function(require,module,exports){
"use strict";
...
},{"jquery":"jquery"}],130:[function(require,module,exports){
"use strict";
...
},{"Top.mustache":98,"content/core/Views/EscChainOfResponsibility":140,"content/core/Views/View":141,"content/messagingInterface":143,"content/mixpanel":144,"jquery":"jquery","underscore":94}],131:[function(require,module,exports){
"use strict";
...
},{"content/Views/Mixins/Tooltip":129,"content/core/Views/View":141,"jquery":"jquery","underscore":94}],132:[function(require,module,exports){
"use strict";
...
},{"UnsafeContentBar.mustache":99,"content/Models/URLClassification":119,"content/Views/Indicators/Close":126,"content/core/Views/View":141,"content/messagingInterface":143}],133:[function(require,module,exports){
"use strict";
...
},{"backbone":17,"content/Models/I18n":115,"content/Routers/App":120,"content/Views/Top":130,"content/appOffersInit":3,"content/appSafetyInit":4,"content/i18n_loader":142,"content/messagingInterface":143,"jquery":"jquery"}],134:[function(require,module,exports){
"use strict";
...
},{"backbone":17,"content/messagingInterface":143,"jquery":"jquery"}],135:[function(require,module,exports){
"use strict";
...
},{"content/Transitions/DashTransition":121,"content/Transitions/Default":122,"content/Transitions/TourStepTransition":123,"content/core/Routing/AreasManagement/base/ViewTransitionStrategy":137,"modules/offers/content/iframe/transitions/OffersIndicatorBarTransition":153,"modules/offers/content/iframe/transitions/OffesDashTransition":154}],137:[function(require,module,exports){
"use strict";
...
},{"core-js/modules/es6.array.iterator.js":64,"core-js/modules/web.dom.iterable.js":65}],138:[function(require,module,exports){
"use strict";
...
},{"backbone":17,"backbone.routefilter":16,"content/core/Routing/AreasManagement/AreasManager":135,"content/messagingInterface":143}],139:[function(require,module,exports){
"use strict";
...
},{"backbone":17,"backbone-subviews":15,"content/Models/I18n":115,"core-js/modules/es6.array.iterator.js":64,"core-js/modules/web.dom.iterable.js":65,"mustache":"mustache","perfect-scrollbar/jquery":73,"underscore":94}],142:[function(require,module,exports){
"use strict";
...
},{"Locale":112,"Locales":113,"config":114,"content/messagingInterface":143,"underscore":94}],143:[function(require,module,exports){
"use strict";
...
},{"messenger/Content":66}],144:[function(require,module,exports){
"use strict";
...
},{"content/Models/State":118,"content/messagingInterface":143,"modules/offers/content/iframe/models/Ciuvo":149,"modules/offers/content/iframe/routers/Offers":152}],146:[function(require,module,exports){
"use strict";
...
},{"content/messagingInterface":143,"modules/offers/content/Scraper":147,"ms":72}],147:[function(require,module,exports){
"use strict";
...
},{"ciuvo/ciuvo-addon-sdk.min":18,"core-js/modules/es6.array.iterator.js":64,"core-js/modules/web.dom.iterable.js":65}],148:[function(require,module,exports){
"use strict";
...
},{"backbone":17,"content/messagingInterface":143,"modules/offers/content/iframe/models/CiuvoProduct":151}],149:[function(require,module,exports){
"use strict";
...
},{"@babel/runtime/helpers/defineProperty":8,"@babel/runtime/helpers/interopRequireDefault":11,"backbone":17,"content/messagingInterface":143,"content/mixpanel":144,"jquery":"jquery","modules/offers/content/Offers":146,"modules/offers/content/iframe/collections/CiuvoProduct":148,"modules/offers/content/iframe/models/CiuvoNotification":150,"underscore":94}],150:[function(require,module,exports){
"use strict";
...
},{"backbone":17}],151:[function(require,module,exports){
"use strict";
...
},{"backbone":17}],152:[function(require,module,exports){
"use strict";
...
},{"content/Transitions/Default":122,"modules/offers/content/iframe/views/OffersDash":158}],155:[function(require,module,exports){
"use strict";
...
},{"content/Views/Indicators/Close":126,"modules/offers/content/iframe/views/CouponIndicator":156,"modules/offers/content/iframe/views/OffersIndicatorBar":160}],158:[function(require,module,exports){
"use strict";
...
},{"content/Views/Dash/TabView":125,"modules/offers/content/iframe/models/Ciuvo":149,"modules/offers/content/iframe/views/mixins/Offers":163}],159:[function(require,module,exports){
"use strict";
...
},{"content/Views/Indicators/Indicator":127,"content/messagingInterface":143,"jquery":"jquery","modules/offers/content/iframe/models/Ciuvo":149,"modules/offers/content/iframe/views/mixins/Offers":163}],160:[function(require,module,exports){
"use strict";
...
},{"IndicatorBarOffers.mustache":95,"backbone":17,"content/Views/Indicators/Close":126,"content/core/Views/View":141,"content/messagingInterface":143,"jquery":"jquery","modules/offers/content/iframe/models/Ciuvo":149,"modules/offers/content/iframe/views/OffersIndicator":159}],161:[function(require,module,exports){
"use strict";
...
},{"content/Views/Tour/TourStepBase":131,"modules/offers/content/iframe/models/Ciuvo":149,"modules/offers/content/iframe/views/mixins/Offers":163}],162:[function(require,module,exports){
"use strict";
...
},{"content/Views/Tour/TourStepBase":131,"modules/offers/content/iframe/models/Ciuvo":149,"modules/offers/content/iframe/views/mixins/Offers":163}],163:[function(require,module,exports){
"use strict";
...
},{"content/messagingInterface":143,"core-js/modules/es6.array.iterator.js":64,"core-js/modules/web.dom.iterable.js":65,"modules/offers/content/Offers":146,"underscore":94}]},{},[133]);
