...
(function () {
  ...
  function calculateRatingPercent(rating) {
    return Math.round(parseFloat(rating, 10) / 5 * 100);
  }
  ...
  common.listing.beforeRender = function beforeRender(data) {
    ...
    if (isCatalog) {
      ...
      products = sortBy_1(products, 'price');
  ...
  common.wishlist.beforeRender = function beforeRender(data) {
    ...
    if (scrapedData.notification.category !== 'Product' && scrapedData.notification.category !== 'Similar') {
      isNotProduct = true;
    } else {
      isNotProduct = false;
    }
  ...
  couponsWithOffers.notification.beforeRender = function beforeRender(data) {
    ...
    var productsByPrice = sortBy_1(productsToShow, 'price');
