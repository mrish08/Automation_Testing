...
module.exports = "<div id=\"help-menu\" class=\"tooltip tooltip--s tooltip--bottom tooltip--list\">\n  <div class=\"tooltip__content txt--center p0\">\n    <a href=\"{{> lnk_abs_landing }}\" data-target=\"_blank\" class=\"tooltip__item\">{{> lb_discover_mode }}</a>\n    <a href=\"https://chrome.google.com/webstore/detail/avira-browser-safety/flliilndjeohchalpbbcdekjklbdgfkk\" data-target=\"_blank\" class=\"tooltip__item\">{{> lb_rate }}</a>\n  </div>\n</div>\n";
...
},{"core-js/modules/es6.array.iterator.js":66,"core-js/modules/web.dom.iterable.js":67}],3:[function(require,module,exports){
"use strict";
...
const urlClassification = require('content/Models/URLClassification').getInstance();

const i18nLoader = require('content/i18n_loader');

const getRouter = require('popup/getRouter');

const PopupView = require('popup/Views/Popup');

const MenuView = require('popup/Views/Menu');

const I18n = require('content/Models/I18n');

const popupInit = require('popup/init');

const config = require('config'); // setTimeout fixes https://bugzilla.mozilla.org/show_bug.cgi?id=1308421


setTimeout(() => {
  i18nLoader.getLocaleStrings((strings, language) => {
    I18n.getInstance().set({
      strings,
      language
    });
    popupInit().then(([tab]) => {
      messenger.publish('Popup:open', {
        tabId: tab.id,
        url: tab.url
      });
      messenger.publish('Tabs:getData', {
        ...
        urlClassification.set(aucData);
        getRouter();
        new PopupView();
        new MenuView();
        Backbone.history.start();
      });
      messenger.publish('offersSupported', null, value => {
        config.supportedSettings.offers = value;
      });
    });
  });
}, 0);

},{"backbone":19,"config":127,"content/Models/I18n":128,"content/Models/URLClassification":133,"content/i18n_loader":150,"content/messagingInterface":151,"core-js/modules/es6.array.iterator.js":66,"core-js/modules/web.dom.iterable.js":67,"popup/Views/Menu":177,"popup/Views/Popup":179,"popup/getRouter":186,"popup/init":187}],7:[function(require,module,exports){
...
module.exports["default"] = module.exports, module.exports.__esModule = true;
},{"./assertThisInitialized.js":7,"@babel/runtime/helpers/typeof":16}],15:[function(require,module,exports){
...
},{"backbone":19,"underscore":96}],18:[function(require,module,exports){
(function(factory) {
  if (typeof define === 'function' && define.amd) {
...
},{"backbone":19,"underscore":96}],19:[function(require,module,exports){
...
},{"jquery":"jquery","underscore":96}],20:[function(require,module,exports){
...
},{"./_hide":37,"./_wks":65}],23:[function(require,module,exports){
...
},{"./_is-object":41}],24:[function(require,module,exports){
// false -> Array#indexOf
// true  -> Array#includes
...
},{"./_to-absolute-index":58,"./_to-iobject":60,"./_to-length":61}],25:[function(require,module,exports){
...
},{"./_global":35,"./_is-object":41}],31:[function(require,module,exports){
...
},{"./_core":26,"./_ctx":27,"./_global":35,"./_hide":37,"./_redefine":54}],33:[function(require,module,exports){
...
},{"./_shared":57}],35:[function(require,module,exports){
...
},{"./_descriptors":29,"./_object-dp":48,"./_property-desc":53}],38:[function(require,module,exports){
var document = require('./_global').document;
...
},{"./_hide":37,"./_object-create":47,"./_property-desc":53,"./_set-to-string-tag":55,"./_wks":65}],43:[function(require,module,exports){
'use strict';
...
},{"./_export":32,"./_hide":37,"./_iter-create":42,"./_iterators":45,"./_library":46,"./_object-gpo":50,"./_redefine":54,"./_set-to-string-tag":55,"./_wks":65}],44:[function(require,module,exports){
...
},{"./_an-object":23,"./_dom-create":30,"./_enum-bug-keys":31,"./_html":38,"./_object-dps":49,"./_shared-key":56}],48:[function(require,module,exports){
var anObject = require('./_an-object');
...
},{"./_an-object":23,"./_descriptors":29,"./_ie8-dom-define":39,"./_to-primitive":63}],49:[function(require,module,exports){
var dP = require('./_object-dp');
var anObject = require('./_an-object');
...
},{"./_an-object":23,"./_descriptors":29,"./_object-dp":48,"./_object-keys":52}],50:[function(require,module,exports){
...
},{"./_has":36,"./_shared-key":56,"./_to-object":62}],51:[function(require,module,exports){
var has = require('./_has');
var toIObject = require('./_to-iobject');
...
},{"./_array-includes":24,"./_has":36,"./_shared-key":56,"./_to-iobject":60}],52:[function(require,module,exports){
...
},{"./_enum-bug-keys":31,"./_object-keys-internal":51}],53:[function(require,module,exports){
...
},{"./_core":26,"./_function-to-string":34,"./_global":35,"./_has":36,"./_hide":37,"./_uid":64}],55:[function(require,module,exports){
...
},{"./_has":36,"./_object-dp":48,"./_wks":65}],56:[function(require,module,exports){
...
},{"./_core":26,"./_global":35,"./_library":46}],58:[function(require,module,exports){
...
},{"./_defined":28,"./_iobject":40}],61:[function(require,module,exports){
// 7.1.15 ToLength
var toInteger = require('./_to-integer');
var min = Math.min;
module.exports = function (it) {
...
},{"./_defined":28}],63:[function(require,module,exports){
...
},{"./_is-object":41}],64:[function(require,module,exports){
var id = 0;
var px = Math.random();
module.exports = function (key) {
...
},{"./_global":35,"./_shared":57,"./_uid":64}],66:[function(require,module,exports){
'use strict';
...
},{"./_add-to-unscopables":22,"./_iter-define":43,"./_iter-step":44,"./_iterators":45,"./_to-iobject":60}],67:[function(require,module,exports){
...
},{"./_global":35,"./_hide":37,"./_iterators":45,"./_object-keys":52,"./_redefine":54,"./_wks":65,"./es6.array.iterator":66}],68:[function(require,module,exports){
"use strict";

module.exports = require('./src/ContentMessenger');

},{"./src/ContentMessenger":69}],69:[function(require,module,exports){
"use strict";
...
},{"./ContentTopic":70,"./Messenger":71,"./chrome":73,"@babel/runtime/helpers/assertThisInitialized":7,"@babel/runtime/helpers/classCallCheck":8,"@babel/runtime/helpers/createClass":9,"@babel/runtime/helpers/getPrototypeOf":11,"@babel/runtime/helpers/inherits":12,"@babel/runtime/helpers/interopRequireDefault":13,"@babel/runtime/helpers/possibleConstructorReturn":14}],70:[function(require,module,exports){
"use strict";
...
},{"./Topic":72,"./chrome":73,"@babel/runtime/helpers/classCallCheck":8,"@babel/runtime/helpers/getPrototypeOf":11,"@babel/runtime/helpers/inherits":12,"@babel/runtime/helpers/interopRequireDefault":13,"@babel/runtime/helpers/possibleConstructorReturn":14}],71:[function(require,module,exports){
"use strict";
...
},{"@babel/runtime/helpers/classCallCheck":8,"@babel/runtime/helpers/createClass":9,"@babel/runtime/helpers/interopRequireDefault":13}],72:[function(require,module,exports){
"use strict";
...
},{"@babel/runtime/helpers/classCallCheck":8,"@babel/runtime/helpers/createClass":9,"@babel/runtime/helpers/interopRequireDefault":13}],73:[function(require,module,exports){
"use strict";
...
},{"./src/js/adaptor/jquery":76}],76:[function(require,module,exports){
'use strict';
...
},{"../main":81,"../plugin/instances":92}],77:[function(require,module,exports){
'use strict';
...
},{"./plugin/destroy":83,"./plugin/initialize":91,"./plugin/update":95}],82:[function(require,module,exports){
'use strict';
...
},{"../lib/dom":77,"../lib/helper":80,"./instances":92}],84:[function(require,module,exports){
'use strict';
...
},{"../instances":92,"../update-geometry":93,"../update-scroll":94}],85:[function(require,module,exports){
'use strict';
...
},{"../../lib/dom":77,"../../lib/helper":80,"../instances":92,"../update-geometry":93,"../update-scroll":94}],86:[function(require,module,exports){
'use strict';
...
},{"../../lib/dom":77,"../../lib/helper":80,"../instances":92,"../update-geometry":93,"../update-scroll":94}],87:[function(require,module,exports){
'use strict';
...
},{"../instances":92,"../update-geometry":93,"../update-scroll":94}],88:[function(require,module,exports){
'use strict';
...
},{"../instances":92,"../update-geometry":93}],89:[function(require,module,exports){
'use strict';
...
},{"../../lib/helper":80,"../instances":92,"../update-geometry":93,"../update-scroll":94}],90:[function(require,module,exports){
'use strict';
...
},{"../../lib/helper":80,"../instances":92,"../update-geometry":93,"../update-scroll":94}],91:[function(require,module,exports){
'use strict';
...
},{"./handler/click-rail":84,"./handler/drag-scrollbar":85,"./handler/keyboard":86,"./handler/mouse-wheel":87,"./handler/native-scroll":88,"./handler/selection":89,"./handler/touch":90,"./instances":92,"./update-geometry":93}],92:[function(require,module,exports){
'use strict';
...
},{"../lib/dom":77,"../lib/event-manager":78,"../lib/guid":79,"../lib/helper":80,"./default-setting":82}],93:[function(require,module,exports){
'use strict';
...
},{"../lib/dom":77,"../lib/helper":80,"./instances":92,"./update-scroll":94}],94:[function(require,module,exports){
'use strict';
...
},{"./instances":92}],95:[function(require,module,exports){
'use strict';
...
},{"../lib/dom":77,"../lib/helper":80,"./instances":92,"./update-geometry":93,"./update-scroll":94}],96:[function(require,module,exports){
//     Underscore.js 1.8.3
...
module.exports = "<div id=\"header\" data-subview=\"Header\"></div>\n<div class=\"card\">\n <div data-subview=\"Domain\"></div>\n  <div data-subview=\"Classification\"></div>\n  <div id=\"tabs\" data-subview=\"Tabs\"></div>\n  <div id=\"main\" data-subview=\"Main\" class=\"posr flex--g1\"></div>\n </div>\n <div id=\"trackinginfo\">\n <div class=\"txt--center txt--overall section--overall txt--osans txt--m-strong\">\n  {{> lb_blocked_total }}\n </div>\n <div class=\"prm plm ptxs pbxs txt--center txt--xxs txt--lead txt--gray-light txt--osans txt--gray-light-link\">{{> lb_adblocking_credits }}</div>\n</div>";

},{}],98:[function(require,module,exports){
module.exports = "<header>\n  <div data-subview=\"Extension\"></div>\n</header>\n";

},{}],99:[function(require,module,exports){
module.exports = "<div id=\"classification\" class=\"section section--xs txt--m {{ colour }}-bar-bottom\">\n  <div class=\"media\">\n    <div class=\"media__body\">\n      <div class=\"txt--white class__bar txt--semibold section--{{ colour }}\">{{ title }}</div>\n    </div>\n  </div>\n</div>\n";

},{}],100:[function(require,module,exports){
module.exports = "<div id=\"domain\" class=\"section section--s txt--truncate txt--medium txt--center\" title=\"{{ domain }}\">\n  {{ domain }}\n</div>\n";

},{}],101:[function(require,module,exports){
module.exports = "<div class=\"topbar\">\n  <div class=\"head__name\">\n  <div class=\"logo\">\n    <img src=\"/img/avira_icon48.png\" alt=\"\">\n    </div>\n  <h3>{{ extName }}</h3>\n</div>\n";
...
module.exports = "<div class=\"main-wrapper flex flex--col pbxxs\">\n  <div class=\"pbxxs flex--g1\">\n      <div class=\"mrm mlm counters-wrapper flex mbxxs txt--lead txt--lh-s\">\n        <div class=\"counter-wrapper flex--g1 flex--b0 txt--center\">\n          <p><img src=\"/img/abs-trackers-blocked.svg\" alt=\"{{> lb_trackers }}\" height=\"32\" width=\"32\"></p>\n          <p id=\"count-trackers\">\n            {{ countTrackers }}\n          </p>\n          <p id=\"trackers-blocked-text\">\n            {{> lb_trackers_blocked_this_page }}\n          </p>\n        </div>\n\n        <div class=\"ptxl prxxxs\"></div>\n\n        <div class=\"counter-wrapper flex--g1 flex--b0 txt--center\">\n          <p><img src=\"/img/abs-ads-blocked.svg\" alt=\"{{> lb_ads }}\" height=\"32\" width=\"32\"></p>\n          <p id=\"count-ads\">\n            {{ countAds }}\n          </p>\n          <p>\n            {{> lb_ads_blocked_this_page }}\n          </p>\n        </div>\n      </div>\n      <div class=\"section section--s section--grey-border-top\">\n        <label class=\"setting mrxxs mlxxs\" for=\"toggle-blocked\">\n          <span class=\"setting__title\">\n            {{> lb_trackers_block_all }}\n          </span>\n          <input\n            id=\"toggle-blocked\"\n            name=\"whitelisted\"\n            type=\"checkbox\"\n            {{# adguard }}{{^ whitelisted }} checked {{/ whitelisted }}{{/ adguard }}\n            {{^ adguard }} disabled {{/ adguard }}>\n          <div class=\"setting__switch\"></div>\n        </label>\n      </div>\n  </div>\n</div>\n";

},{}],105:[function(require,module,exports){
module.exports = "<div class=\"section\">\n  <div class=\"txt--center\">\n    <h2 id=\"title\" class=\"txt--m txt--osans txt--lh-medium\">{{ title }}</h2>\n    {{# subtitle}}\n      <p id=\"subtitle\" class=\"txt--lead mbxs\">{{ subtitle }}</p>\n    {{/ subtitle}}\n\n    {{# isPUADownload }}\n      <p id=\"subtitle\" class=\"txt--lead mbxs\"><a class=\"txt--dec-none\" href=\"{{> lnk_what_is_pua }}\" target=\"_blank\">{{> msg_what_is_pua }}</a></p>\n    {{/ isPUADownload }}\n\n    {{# isMSE }}\n      <button id=\"btn-mse-take-me-away\" class=\"button button--full mbs\" data-href=\"{{> lnk_avira }}\">{{> lb_mse_take_me_away }}</button>\n    {{/ isMSE }}\n    {{^ isMSE }}\n      <button id=\"btn-back\" class=\"button button--full mbs\">{{> btn_blocking_back }}</button>\n    {{/ isMSE }}\n\n    <div class=\"check\">\n      <input id=\"cb-exception\" type=\"checkbox\" {{# is_exempt }}checked{{/ is_exempt }}/>\n      <label class=\"check__label check__action\" for=\"cb-exception\">\n        <i class=\"check__box\"></i>\n        <span>{{> btn_dash_classification_cb_exception }}</span>\n      </label>\n    </div>\n  </div>\n</div>\n";

},{}],106:[function(require,module,exports){
module.exports = "<div class=\"section--full flex flex--col pbm ptm posa posfull\">\n  <div class=\"prm plm\">\n    <div id=\"security-details\" class=\"txt--center\">\n      <img src=\"{{ image }}\" width=\"70\" class=\"db mla mra mbm\" alt=\"{{ title }}\">\n      <h2 id=\"title\" class=\"txt--l mbs\">{{ title }}</h2>\n      {{# subtitle}}\n        <div id=\"subtitle\" class=\"txt--lead mbxs\">{{ subtitle }}</div>\n      {{/ subtitle}}\n    </div>\n  </div>\n\n  <div class=\"prm plm\">\n    <p class=\"txt--center txt--s pbs\">\n      <a href=\"#\" id=\"unsafe-content-toggle-details\" class=\"txt-toggler\">\n        <span class=\"txt-toggler__inactive\">{{> lb_dash_unsafe_content_show_details }}</span>\n        <span class=\"txt-toggler__active\">{{> lb_dash_unsafe_content_hide_details }}</span>\n      </a>\n    </p>\n  </div>\n\n  <div id=\"unsafe-content-details\" class=\"flex--g1 posr\" style=\"display: none;\">\n    <div class=\"posa posfull\">\n      <div class=\"section--full txt--s flex flex--col flex--sb\">\n        <div class=\"flex--g1\" style=\"min-height: 1px;\">\n          {{! the bottom attr fixes an issue with the height of }}\n          {{! this container not obeying the full height of its parent }}\n          <div class=\"scrollbar posa posfull ovyh prm plm\" style=\"bottom: 54px;\">\n            <p class=\"mbxs\">\n              {{# hasUnsafeContentException }}\n                {{> msg_dash_unsafe_content_details_exception }}\n              {{/ hasUnsafeContentException }}\n              {{^ hasUnsafeContentException }}\n                {{> msg_dash_unsafe_content_details_no_exception }}\n              {{/ hasUnsafeContentException }}\n            </p>\n            <ul class=\"mbxs\">\n              {{# unsafeContentURLs }}\n                <li class=\"txt--xs txt--mono wba mbxs\">{{ . }}</li>\n              {{/ unsafeContentURLs }}\n            </ul>\n            <p>\n              {{# hasUnsafeContentException }}\n                {{> msg_dash_unsafe_content_risk_exception }}\n              {{/ hasUnsafeContentException }}\n              {{^ hasUnsafeContentException }}\n                {{> msg_dash_unsafe_content_risk_no_exception }}\n              {{/ hasUnsafeContentException }}\n            </p>\n          </div>\n        </div>\n        <div>\n          <div class=\"txt--center mb0 pts\">\n            <div class=\"check\">\n              <input id=\"cb-unsafe-content-exception\" type=\"checkbox\" {{# hasUnsafeContentException }}checked{{/ hasUnsafeContentException }}/>\n              <label class=\"check__label check__action\" for=\"cb-unsafe-content-exception\">\n                <i class=\"check__box\"></i>\n                <span>{{> btn_dash_classification_cb_exception }}</span>\n              </label>\n            </div>\n          </div>\n        </div>\n      </div>\n    </div>\n  </div>\n</div>\n";

},{}],107:[function(require,module,exports){
module.exports = "<label class=\"setting\" for=\"setting-switch-{{ name }}\">\n  <span class=\"setting__title prs\">\n    {{ caption }}\n  </span>\n  <span class=\"setting__info\">\n    {{# tooltip }}\n      <img class=\"vam\" data-tooltip=\"{{ tooltip }}\" src=\"/img/abs-info-badge.svg\">\n    {{/ tooltip }}\n    </span>\n  <input\n    id=\"setting-switch-{{ name }}\"\n    name=\"{{ name }}\"\n    type=\"checkbox\"\n    {{# disabled }} disabled {{/ disabled }}\n    {{# value }} checked {{/ value }}>\n\n  <div class=\"setting__switch\"></div>\n</label>\n";

},{}],108:[function(require,module,exports){
module.exports = "<div class=\"settings flex flex--col\">\n  <div class=\"head__name\">\n    <div class=\"topbar\">\n      <a href=\"#\" class=\"settings__back-button\"></a>\n      <h3>{{> lb_settings }}</h3>\n    </div>\n  </div>\n  <div class=\"flex--g1 posr scrollbar\">\n    <ul class=\"section section--s settings-list\">\n      {{# settings }}\n        <li class=\"settings-list__item\">\n          {{> setting }}\n        </li>\n      {{/ settings }}\n    </ul>\n  </div>\n  {{> footer }}\n</div>\n";

},{}],109:[function(require,module,exports){
module.exports = "";

},{}],110:[function(require,module,exports){
module.exports = "<div class=\"tabs txt--xxs txt--semibold txt--osans\">\n  {{# sections }}\n    {{# active }}\n      <a href=\"#{{ name }}\" class=\"tabs__item tabs__item--active\" title=\"{{ title }}\" id=\"{{ elementId }}\">{{ title }}</a>\n    {{/ active }}\n    {{^ active }}\n      <a href=\"#{{ name }}\" class=\"tabs__item\" id=\"{{ elementId }}\">{{ title }}</a>\n    {{/ active }}\n  {{/ sections }}\n</div>\n";

},{}],111:[function(require,module,exports){
module.exports = "<div class=\"tooltip\">\n  <div class=\"tooltip__content txt--center\">\n    {{{ message }}}\n  </div>\n</div>\n";
...
},{"core-js/modules/es6.array.iterator.js":66,"core-js/modules/web.dom.iterable.js":67}],125:[function(require,module,exports){
"use strict";
...
},{"i18n/de-DE":112,"i18n/en-US":113,"i18n/es-ES":114,"i18n/fr-FR":115,"i18n/it-IT":116,"i18n/ja-JP":117,"i18n/nl-NL":118,"i18n/pt-BR":119,"i18n/ru-RU":120,"i18n/tr-TR":121,"i18n/zh-CN":122,"i18n/zh-TW":123}],126:[function(require,module,exports){
"use strict";
...
},{"background/localStorage":2,"configuration":5,"underscore":96}],128:[function(require,module,exports){
"use strict";
...
},{"content/core/Models/ModelBackground":143}],129:[function(require,module,exports){
"use strict";
...
},{"content/core/Models/ModelBackground":143,"content/messagingInterface":151}],130:[function(require,module,exports){
"use strict";
...
},{"content/core/Models/ModelBackground":143}],131:[function(require,module,exports){
"use strict";
...
},{"content/Models/base/Settings":134}],132:[function(require,module,exports){
"use strict";
...
},{"content/Models/PUA":129,"content/Models/SERP":130,"content/Models/URLClassification":133,"content/core/Models/ModelBackground":143,"content/messagingInterface":151,"modules/offers/content/iframe/models/Ciuvo":156}],133:[function(require,module,exports){
"use strict";
...
},{"content/core/Models/ModelBackground":143}],134:[function(require,module,exports){
"use strict";
...
},{"backbone":19,"content/messagingInterface":151,"jquery":"jquery","underscore":96}],135:[function(require,module,exports){
"use strict";
...
},{"content/Transitions/Default":136,"content/Views/Dash/TabView":138,"jquery":"jquery"}],136:[function(require,module,exports){
"use strict";
...
},{"content/core/Transitions/Base":148,"content/core/Views/View":149,"jquery":"jquery"}],137:[function(require,module,exports){
"use strict";
...
},{"content/Transitions/Default":136,"content/Views/Tour/TourStepBase":142}],138:[function(require,module,exports){
"use strict";
...
},{"content/core/Views/View":149}],139:[function(require,module,exports){
"use strict";
...
},{"Indicators/Close.mustache":103,"content/Views/Indicators/Indicator":140}],140:[function(require,module,exports){
"use strict";
...
},{"content/Models/State":132,"content/core/Views/View":149}],141:[function(require,module,exports){
"use strict";
...
},{"jquery":"jquery"}],142:[function(require,module,exports){
"use strict";
...
},{"content/Views/Mixins/Tooltip":141,"content/core/Views/View":149,"jquery":"jquery","underscore":96}],143:[function(require,module,exports){
"use strict";
...
},{"backbone":19,"content/messagingInterface":151,"jquery":"jquery"}],144:[function(require,module,exports){
"use strict";
...
},{"content/core/Routing/AreasManagement/ViewTransitionStrategy":145}],145:[function(require,module,exports){
"use strict";
...
},{"content/Transitions/DashTransition":135,"content/Transitions/Default":136,"content/Transitions/TourStepTransition":137,"content/core/Routing/AreasManagement/base/ViewTransitionStrategy":146,"modules/offers/content/iframe/transitions/OffersIndicatorBarTransition":159,"modules/offers/content/iframe/transitions/OffesDashTransition":160}],146:[function(require,module,exports){
"use strict";
...
},{"core-js/modules/es6.array.iterator.js":66,"core-js/modules/web.dom.iterable.js":67}],147:[function(require,module,exports){
"use strict";
...
},{"backbone":19,"backbone.routefilter":18,"content/core/Routing/AreasManagement/AreasManager":144,"content/messagingInterface":151}],148:[function(require,module,exports){
"use strict";
...
},{"backbone":19,"backbone-subviews":17,"content/Models/I18n":128,"core-js/modules/es6.array.iterator.js":66,"core-js/modules/web.dom.iterable.js":67,"mustache":"mustache","perfect-scrollbar/jquery":75,"underscore":96}],150:[function(require,module,exports){
"use strict";
...
},{"Locale":124,"Locales":125,"config":127,"content/messagingInterface":151,"underscore":96}],151:[function(require,module,exports){
"use strict";
...
},{"messenger/Content":68}],152:[function(require,module,exports){
"use strict";
...
},{"content/messagingInterface":151}],153:[function(require,module,exports){
"use strict";
...
},{"content/messagingInterface":151,"modules/offers/content/Scraper":154,"ms":74}],154:[function(require,module,exports){
"use strict";
...
},{"ciuvo/ciuvo-addon-sdk.min":20,"core-js/modules/es6.array.iterator.js":66,"core-js/modules/web.dom.iterable.js":67}],155:[function(require,module,exports){
"use strict";
...
},{"backbone":19,"content/messagingInterface":151,"modules/offers/content/iframe/models/CiuvoProduct":158}],156:[function(require,module,exports){
"use strict";
...
class Ciuvo extends Backbone.Model {
  ...
  _setData(req) {
    ...
    const firstProduct = this.get('products').first();
...
},{"@babel/runtime/helpers/defineProperty":10,"@babel/runtime/helpers/interopRequireDefault":13,"backbone":19,"content/messagingInterface":151,"content/mixpanel":152,"jquery":"jquery","modules/offers/content/Offers":153,"modules/offers/content/iframe/collections/CiuvoProduct":155,"modules/offers/content/iframe/models/CiuvoNotification":157,"underscore":96}],157:[function(require,module,exports){
"use strict";
...
},{"backbone":19}],158:[function(require,module,exports){
"use strict";
...
},{"backbone":19}],159:[function(require,module,exports){
"use strict";
...
},{"content/core/Transitions/Base":148,"modules/offers/content/iframe/views/OffersIndicatorBar":163}],160:[function(require,module,exports){
"use strict";
...
},{"content/Transitions/Default":136,"modules/offers/content/iframe/views/OffersDash":161}],161:[function(require,module,exports){
"use strict";
...
},{"content/Views/Dash/TabView":138,"modules/offers/content/iframe/models/Ciuvo":156,"modules/offers/content/iframe/views/mixins/Offers":164}],162:[function(require,module,exports){
"use strict";
...
},{"content/Views/Indicators/Indicator":140,"content/messagingInterface":151,"jquery":"jquery","modules/offers/content/iframe/models/Ciuvo":156,"modules/offers/content/iframe/views/mixins/Offers":164}],163:[function(require,module,exports){
"use strict";
...
},{"IndicatorBarOffers.mustache":102,"backbone":19,"content/Views/Indicators/Close":139,"content/core/Views/View":149,"content/messagingInterface":151,"jquery":"jquery","modules/offers/content/iframe/models/Ciuvo":156,"modules/offers/content/iframe/views/OffersIndicator":162}],164:[function(require,module,exports){
"use strict";
...
},{"content/messagingInterface":151,"core-js/modules/es6.array.iterator.js":66,"core-js/modules/web.dom.iterable.js":67,"modules/offers/content/Offers":153,"underscore":96}],165:[function(require,module,exports){
"use strict";
...
const TabModel = require('popup/Models/Tab');

class AdguardModel extends Backbone.Model {
  static getInstance() {
    if (!this.instance) {
      this.instance = new this();
    }
  ...
  sync(method, model) {
    // Using Deferred instead of Promise to be consistent with Backbone's API
    if (this._promise) {
      return this._promise;
    }

    const pTab = TabModel.getInstance().fetch();
    const pAdguard = pTab.then(tab => new $.Deferred(deferred => {
      messenger.publish('Tabs:getData', {
        tabId: tab.id,
        classifier: 'Adguard'
      }, data => {
    ...
    const pWhitelisted = pTab.then(({
      url
    }) => new $.Deferred(deferred => {
      messenger.publish('Adguard:isWhitelisted', {
        url
      }, data => deferred.resolve(data));
      model.on('change:whitelisted', (model_, value) => {
        if (model.previous('whitelisted') != null) {
          messenger.publish('Adguard:setWhitelisted', {
            url,
            value
          });
        }
    ...
    const pCountTotal = new $.Deferred(deferred => {
      messenger.publish('Adguard:getCountTotal', null, countTotal => {
        deferred.resolve(countTotal);
      });
    });
    this._promise = $.when(pAdguard, pWhitelisted, pCountTotal).done((adguard, whitelisted, countTotal) => {
      const data = _.extend({
        whitelisted,
        countTotal
      }, adguard);
    ...
    messenger.subscribe('Tabs:change', ({
      Adguard
    }) => {
      if (Adguard) {
        model.set(Adguard);
        messenger.publish('Adguard:getCountTotal', null, countTotal => model.set({
          countTotal
        }));
      }
    });
...
module.exports = AdguardModel;

},{"backbone":19,"content/messagingInterface":151,"jquery":"jquery","popup/Models/Tab":166,"underscore":96}],166:[function(require,module,exports){
"use strict";
...
class TabModel extends Backbone.Model {
  ...
  sync(method, model) {
    // Using Deferred instead of Promise to be consistent with Backbone's API
    this._pCurrentTab = this._pCurrentTab || new $.Deferred(deferred => {
      messenger.publish('getCurrentTab', null, tab => {
        model.set(_.pick(tab, ['id', 'url']));
        deferred.resolve(tab);
      });
    });
    return this._pCurrentTab.promise();
  }
...
},{"backbone":19,"content/messagingInterface":151,"jquery":"jquery","underscore":96}],167:[function(require,module,exports){
"use strict";
...
const HeaderView = require('popup/Views/Header');

const PrivacyView = require('popup/Views/Main/Privacy');

const SecurityView = require('popup/Views/Main/Security');

const SecurityUnsafeContentView = require('popup/Views/Main/SecurityUnsafeContent');

const TabsView = require('popup/Views/Tabs');

const SettingsView = require('popup/Views/Settings');

const ClassificationView = require('popup/Views/Classification');

const TransitionStrategy = require('popup/core/Routing/AreasManagement/ViewTransitionStrategy');

const DomainView = require('popup/Views/Header/Domain');

const ClassificationHeaderView = require('popup/Views/Header/Classification');
...
class Router extends BaseRouter {
  constructor() {
    super();
    this._areasManager = new AreasManager(['page'], TransitionStrategy);
  }
  ...
  default() {
    const unsafe = urlClassification.isUnsafe() || urlClassification.get('hasUnsafeContent');

    if (unsafe && Backbone.history.getFragment() === '') {
      return this.navigate('dash/security', {
        trigger: true,
        replace: true
      });
    }

    if (Backbone.history.getFragment() !== 'dash/privacy') {
      return this.navigate('dash/privacy', {
        trigger: true,
        replace: true
      });
    }
    ...
    return this.setAreas({
      page: new ClassificationView({
        subviewConstructors: {
          Header: HeaderView,
          Tabs: TabsView,
          Main: PrivacyView,
          Domain: DomainView,
          Classification: ClassificationHeaderView
        }
      })
    });
  }
  ...
  security() {
    ...
    const MainView = urlClassification.get('hasUnsafeContent') ? SecurityUnsafeContentView : SecurityView;
    return this.setAreas({
      page: new ClassificationView({
        subviewConstructors: {
          Header: HeaderView,
...
},{"backbone":19,"content/Models/URLClassification":133,"content/core/Routing/AreasManagement/AreasManager":144,"content/core/Routing/Router":147,"popup/Views/Classification":169,"popup/Views/Header":170,"popup/Views/Header/Classification":171,"popup/Views/Header/Domain":172,"popup/Views/Main/Privacy":174,"popup/Views/Main/Security":175,"popup/Views/Main/SecurityUnsafeContent":176,"popup/Views/Settings":180,"popup/Views/Tabs":181,"popup/core/Routing/AreasManagement/ViewTransitionStrategy":185}],168:[function(require,module,exports){
"use strict";

const _ = require('underscore');

const DefaultTransition = require('content/Transitions/Default');

const PageView = require('popup/Views/Page');
/**
 *  Responsible for rendering transition animation when switching tabs
 */


class PageTransition extends DefaultTransition {
  execute(callback) {
    if (this.from.xIndex === this.to.xIndex) {
    ...
    this.to.render();
    this.to.$el.css('left', toInitial);
    this.from.$el.css('left', fromInitial);
    this.to.show();
    return setTimeout(() => {
      this.from.$el.css('left', fromFinal);
      this.to.$el.css('left', toFinal);
      this.from.$el.on('transitionend', () => {
        this.from.hide();
        this.from.remove();
        this.from.$el.remove();
        callback();
...
},{"content/Transitions/Default":136,"popup/Views/Page":178,"underscore":96}],169:[function(require,module,exports){
"use strict";

const PageView = require('popup/Views/Page');

const ClassificationTemplate = require('Classification.mustache');

const Adguard = require('popup/Models/Adguard');

class ClassificationView extends PageView.extend({
  template: ClassificationTemplate,
  xIndex: 1
}) {
  initialize(options) {
    this.model = Adguard.getInstance();
    PageView.prototype.initialize.call(this, options);
  }

  afterRender() {
    const tabs = this.$('#tabs');
    const trackersText = this.$('#trackers-blocked-text');
    ...
    if (tabs.height() <= 0) {
      this.$('.counter-wrapper').addClass('notabs');
    }

    if (!trackersText) {
      return;
    } // in some cases language text is longer -> reduce padding a bit to not clutter


    const countExists = this.$('#count-trackers').height() > 0;

    if (trackersText.height() >= 50 && countExists) {
      this.$('.counter-wrapper').addClass('ptxxs');
    }
  }

}

module.exports = ClassificationView;

},{"Classification.mustache":97,"popup/Models/Adguard":165,"popup/Views/Page":178}],170:[function(require,module,exports){
"use strict";

const View = require('content/core/Views/View');

const HeaderTemplate = require('Header.mustache');

const ExtensionView = require('popup/Views/Header/Extension');
...
},{"Header.mustache":98,"content/core/Views/View":149,"popup/Views/Header/Extension":173}],171:[function(require,module,exports){
"use strict";

const View = require('content/core/Views/View');

const ClassificationTemplate = require('Header/Classification.mustache');

const UrlClassification = require('content/Models/URLClassification');

const I18n = require('content/Models/I18n');
/**
 *  Responsible for rendering classification part of the header
 */


const ClassificationView = View.extend({
  template: ClassificationTemplate,

  _getTitleKey(model) {
    if (model.get('unsafe') || model.get('isMSE')) {
      return 'lb_unsafe_website';
    }

    if (model.get('isPUA') || model.get('hasUnsafeContent')) {
      return 'lb_unsafe_content_website';
    }

    return 'lb_safe_website';
  },

  _getImage(model) {
    if (model.isUnsafe() || model.get('hasUnsafeContent')) {
      return '/img/abs-attention-small-yellow.png';
    }

    return '/img/abs-check-small.png';
  },
  ...
  beforeRender() {
    const urlClassification = UrlClassification.getInstance();
    const i18n = I18n.getInstance().get('strings');
    return {
      image: this._getImage(urlClassification),
      title: i18n[this._getTitleKey(urlClassification)],
      colour: this._getColour(urlClassification)
    };
  }
...
},{"Header/Classification.mustache":99,"content/Models/I18n":128,"content/Models/URLClassification":133,"content/core/Views/View":149}],172:[function(require,module,exports){
"use strict";

const View = require('content/core/Views/View');

const DomainTemplate = require('Header/Domain.mustache');

const _ = require('underscore');

const urlClassification = require('content/Models/URLClassification').getInstance();
/**
 *  Responsible for rendering the domain inside the header
 */


const DomainView = View.extend({
  template: DomainTemplate,

  beforeRender(data) {
    return _.extend(data, {
      domain: urlClassification.get('domain') || urlClassification.get('url')
    });
  }
...
},{"Header/Domain.mustache":100,"content/Models/URLClassification":133,"content/core/Views/View":149,"underscore":96}],173:[function(require,module,exports){
"use strict";

const View = require('content/core/Views/View');

const ExtensionTemplate = require('Header/Extension.mustache');

const extensionAccessor = require('browser_accessors/extensionAccessor');

const _ = require('underscore');
/**
 *  Responsible for rendering the extension name inside the header
 */


const ExtensionView = View.extend({
  template: ExtensionTemplate,

  beforeRender(data) {
    return _.extend(data, {
      extName: extensionAccessor.getManifest().name
    });
  }

});
module.exports = ExtensionView;

},{"Header/Extension.mustache":101,"browser_accessors/extensionAccessor":3,"content/core/Views/View":149,"underscore":96}],174:[function(require,module,exports){
"use strict";
...
const TrackersTemplate = require('Main/Privacy.mustache');

const urlClassification = require('content/Models/URLClassification').getInstance();

const settingsModel = require('content/Models/Settings').getInstance();

const Adguard = require('popup/Models/Adguard');

const MAX_DOMAIN_SIZE = 25;

class PrivacyView extends View.extend({
  el: '#main',
  template: TrackersTemplate,
  events: {
    'change #toggle-blocked': '_toggleBlocked'
  },
  className: 'flex--g1 flex main--safe'
}) {
  initialize(options) {
    this.model = Adguard.getInstance();
    this.listenTo(this.model, 'change', model => {
      // TODO: split views to avoid rerendering non needed parts
      if (model.changed.whitelisted == null) {
        this.render();
      }
    }, this);
  ...
  beforeRender(data) {
    const fullDomain = urlClassification.get('domain') || urlClassification.get('url');
    const domain = fullDomain.length > MAX_DOMAIN_SIZE ? `${fullDomain.substring(0, MAX_DOMAIN_SIZE)} ...` : fullDomain;
    const adguard = settingsModel.get('adguard');
    return _.extend(data, {
      fullDomain,
      domain,
      adguard
  ...
  _toggleBlocked() {
    const whitelisted = !this.model.get('whitelisted');
    this.model.set('whitelisted', whitelisted);
    messenger.publish('DNT:update', {
      exception: {
        domain: urlClassification.get('domain') || urlClassification.get('url'),
        action: whitelisted ? 'allow' : 'block'
      }
    });
  }
...
},{"Main/Privacy.mustache":104,"content/Models/Settings":131,"content/Models/URLClassification":133,"content/core/Views/View":149,"messenger/Content":68,"popup/Models/Adguard":165,"underscore":96}],175:[function(require,module,exports){
"use strict";

const View = require('content/core/Views/View');

const SecurityTemplate = require('Main/Security.mustache');
...
const tab = require('popup/Models/Tab').getInstance();

const _ = require('underscore');

const popupAccessor = require('popup/popupAccessor');

class SecurityView extends View.extend({
  el: '#main',
  events: {
    'click #btn-back': '_takeMeAway',
    'change #cb-exception': '_toggleException',
    'click #btn-mse-take-me-away': '_mseTakeMeAway'
  },
  template: SecurityTemplate
}) {
  _takeMeAway(e) {
    e.preventDefault();
    mixpanel.track('Classification - Take me back', {
      Domain: urlClassification.get('domain'),
      URL: urlClassification.get('url')
    });
    messenger.publish('navigate', {
      tabId: tab.get('id'),
  ...
  _toggleException(e) {
    e.preventDefault();
    const toExempt = e.target.checked;
    let action;
    let eventName;

    if (toExempt) {
      action = 'addException';
      eventName = 'Classification - Add Exception';
    } else {
      action = 'removeException';
      eventName = 'Classification - Remove Exception';
    }

    urlClassification.set('is_exempt', toExempt);
    messenger.publish('AUCClassifier', {
      action,
      permanent: true,
      tabId: tab.get('id'),
      url: tab.get('url')
  ...
  beforeRender() {
    const i18n = I18n.getInstance().get('strings');
    const category = urlClassification.getCategoryName();
    const title = i18n[`msg_category_${category}`];
    const subtitle = i18n[`msg_category_${category}_sub`];
    const isPUADownload = urlClassification.get('category') === 5;
    return _.extend({}, urlClassification.toJSON(), {
      title,
      subtitle,
      image: '/img/abs-attention.png',
      isPUADownload
    });
  }
...
},{"Main/Security.mustache":105,"content/Models/I18n":128,"content/Models/URLClassification":133,"content/core/Views/View":149,"content/messagingInterface":151,"content/mixpanel":152,"popup/Models/Tab":166,"popup/popupAccessor":188,"underscore":96}],176:[function(require,module,exports){
"use strict";

const View = require('content/core/Views/View');

const SecurityUnsafeContentTemplate = require('Main/SecurityUnsafeContent.mustache');
...
const SecurityView = View.extend({
  el: '#main',
  events: {
    'click #unsafe-content-toggle-details': '_toggleDetails',
    'change #cb-unsafe-content-exception': '_toggleException'
  },
  template: SecurityUnsafeContentTemplate,

  _toggleDetails(e) {
    e.preventDefault();
    this.$(e.currentTarget).toggleClass('txt-toggler--active');
    this.$('#unsafe-content-details').animate({
      opacity: 'toggle',
      height: 'toggle'
    });
    this.$('#security-details').animate({
      opacity: 'toggle',
      height: 'toggle'
    });
  },
  ...
  _toggleException(e) {
    ...
    if (toExempt) {
      action = 'addUCException';
      eventName = 'UnsafeContent - Add Exception';
    } else {
      action = 'removeUCException';
      eventName = 'UnsafeContent - Remove Exception';
    }

    urlClassification.set('hasUnsafeContentException', toExempt);
    messenger.publish('AUCClassifier', {
      action,
      url: tab.get('url')
    });
...
},{"Main/SecurityUnsafeContent.mustache":106,"content/Models/I18n":128,"content/Models/URLClassification":133,"content/core/Views/View":149,"content/messagingInterface":151,"content/mixpanel":152,"popup/Models/Tab":166,"underscore":96}],177:[function(require,module,exports){
"use strict";
...
const TooltipView = require('popup/Views/Tooltip');

const HelpMenuTemplate = require('Menu/Help.mustache');

const PopupRouter = require('popup/Router');
...
class MenuView extends Backbone.View {
  ...
  get events() {
    return {
      'click .menu__close': '_closePopup',
      'click .menu__help': '_openHelp'
    };
  }
  ...
  initialize(options) {
    ...
    const $el = this.$('.menu__help');
    this.helpMenu = new TooltipView({
      owner: $el,
      container: this.$el,
      position: 'bottom',
      template: HelpMenuTemplate
    });
    PopupRouter.getInstance().on('route', route => {
      this.$('.menu__item').removeClass('menu__item--active').filter(`[active="${route}"]`).addClass('menu__item--active');
    });
  }
  ...
  _openHelp(e) {
    ...
    const removeFn = event => {
      if (!event || !$.contains(this.helpMenu.$el.get(0), event.target)) {
        body.off('click', removeFn);
        this.helpMenu.remove();
      }
    };

    if ($.contains(document, this.helpMenu.$el.get(0))) {
      return removeFn();
    }

    this.helpMenu.render();
    e.stopPropagation();
    body.on('click', removeFn);
    return undefined;
  }
...
},{"Menu/Help.mustache":1,"backbone":19,"jquery":"jquery","popup/Router":167,"popup/Views/Tooltip":182,"popup/popupAccessor":188}],178:[function(require,module,exports){
"use strict";
...
class PageView extends View.extend({
  el: '#page',
  id: 'page',
  ...
  onSubviewsRendered() {
    setTimeout(() => {
      const height = _.reduce(this.subviews, (h, subview) => h + subview.$el.outerHeight(), 0);

      this.$el.trigger('PageView:rendered', {
        height
      });
    }, 50);
  }
...
},{"content/core/Views/View":149,"underscore":96}],179:[function(require,module,exports){
"use strict";
...
class Popup extends Backbone.View {
  constructor() {
    super();
    this._tooltip = null;
    this._tooltip$el = null;
    this._removeTooltip = this._removeTooltip.bind(this);
    this._darkMode = SettingsModel.getInstance().attributes.dark_mode;
  }

  initialize() {
    this.model = SettingsModel.getInstance();
    this.listenTo(this.model, 'change', model => {
      this._darkMode = model.attributes.dark_mode;
      this.render();
    });
  }
  ...
  get events() {
    return {
      'mouseenter [data-tooltip]': '_showTooltip',
      'click a[data-target="_blank"]': '_openLink',
      'PageView:rendered': '_handleRenderedPage'
    };
  }
  ...
  _showTooltip(e) {
    ...
    $el.on('mouseleave click', this._removeTooltip);
  }

  _removeTooltip() {
    if (this._tooltip) {
      this._tooltip$el.off('mouseleave click', this._removeTooltip);
  ...
  _updateMode() {
    if (this._darkMode) {
      this.$el.addClass('theme-dark');
    } else {
      this.$el.removeClass('theme-dark');
    }
  }

  _handleRenderedPage(e, payload) {
    const height = this.$el.height();

    if (height && payload.height > height) {
      this.$el.add('html').css('height', payload.height);
      messenger.publish('Popup:resized', payload);
    }
...
},{"backbone":19,"content/Models/Settings":131,"content/messagingInterface":151,"popup/Models/Tab":166,"popup/Views/Tooltip":182,"popup/popupAccessor":188}],180:[function(require,module,exports){
"use strict";

const BaseSettingsView = require('popup/Views/base/BaseSettings');

class SettingsView extends BaseSettingsView {}

module.exports = SettingsView;

},{"popup/Views/base/BaseSettings":183}],181:[function(require,module,exports){
"use strict";

const BaseTabs = require('popup/Views/base/BaseTabs');

class Tabs extends BaseTabs {}

module.exports = Tabs;

},{"popup/Views/base/BaseTabs":184}],182:[function(require,module,exports){
"use strict";
...
const TooltipTemplate = require('Tooltip.mustache');
/**
 *  Responsible for rendering the tooltip that is shown on the info icon in the extension popup
 */


const Tooltip = View.extend({
  // Compensates the tooltip arrow height
  HORIZONTAL_OFFSET: 10,
  // Compensates the vertical position of the tooltip arrow
  VERTICAL_OFFSET: 22,
  // Minimum distance from the top of the popup and the tooltip
  MIN_OFFSET_TOP: 5,
  MIN_OFFSET_LEFT: 5,
  ...
  beforeRender(data) {
    return _.extend(data, {
      message: this.owner.data('tooltip')
    });
  },
  ...
  _reposition() {
    ...
    const ownerWidth = this.owner.width();
    const ownerHeight = this.owner.height();
    let topPos;

    if (this.position === 'bottom') {
      topPos = top + ownerHeight + this.HORIZONTAL_OFFSET;
    } else {
      topPos = top - height - this.HORIZONTAL_OFFSET;
    }

    if (topPos < this.MIN_OFFSET_TOP) {
    ...
    if (this.position === 'right') {
      leftPos = left + ownerWidth / 2 - this.VERTICAL_OFFSET;
    } else {
      leftPos = left - width + ownerWidth / 2 + this.VERTICAL_OFFSET;
    }

    if (leftPos < this.MIN_OFFSET_LEFT) {
...
},{"Tooltip.mustache":111,"content/core/Views/View":149,"underscore":96}],183:[function(require,module,exports){
"use strict";
...
const SettingsTemplate = require('Settings/Settings.mustache');

const SettingTemplate = require('Settings/Setting.mustache');

const SettingsFooterTemplate = require('Settings/SettingsFooter.mustache');
...
const config = require('config');
/**
 *  Responsible for rendering the list of settings in the settings tab
 */


class BaseSettingsView extends PageView.extend({
  template: SettingsTemplate,
  xIndex: 10,
  events: {
    'change input': '_toggleSetting',
    'click .settings__back-button': 'goBack'
  },
  templates: {
    setting: SettingTemplate,
    footer: SettingsFooterTemplate
  }
}) {
  initialize(options) {
    this.model = SettingsModel.getInstance();
  ...
  _update(changed) {
    _.each(changed, (value, name) => {
      const input = this.$el.find(`[name="${name}"]`);
  ...
  _updateDisabled() {
    this.getSettings().forEach(setting => {
      const parentKey = DEPENDENCIES[setting];

      if (parentKey) {
        const input = this.$el.find(`[name="${setting}"]`);
        input.prop('disabled', !this.model.get(parentKey));
      }
    });
  }

  _trackSettingChange(name, checked) {
    mixpanel.track(`Settings - Entry - Clicked -  ${name}`, {
      checked
    });
  }
  ...
  _toggleSetting(e) {
    ...
    if (name === 'extension_scan') {
      // special handling using browser permissions
      if (checked) {
        chrome.permissions.request({
          permissions: ['management']
        }, result => {
          // TODO: Do we want a Mixpanel message ?
          this._update({
            extension_scan: result
          });

          this._toggleProp(name, result);

          this._trackSettingChange(name, result);
        ...
        chrome.permissions.remove({
          ...
          if (result) {
            this._toggleProp(name, checked);

            this._trackSettingChange(name, checked);
          }
  ...
  beforeRender(data) {
    return {
      settings: this.getSettings().map(setting => {
        const parentKey = DEPENDENCIES[setting];
        const settingData = {
          name: setting,
          caption: this.i18n[`lb_setting_${setting}`],
          tooltip: this.i18n[`lb_setting_tooltip_${setting}`],
          value: data[setting],
          disabled: !!parentKey && !data[parentKey]
        };
        return settingData;
      })
    };
  ...
  getSettings() {
    ...
    return Object.keys(_.pick(DEFAULTS, (val, key) => supportedSettings[key]));
  }

}

module.exports = BaseSettingsView;

},{"SettingDefaults.json":4,"Settings/Setting.mustache":107,"Settings/Settings.mustache":108,"Settings/SettingsFooter.mustache":109,"Subsettings":126,"config":127,"content/Models/Settings":131,"content/mixpanel":152,"jquery":"jquery","popup/Views/Page":178,"underscore":96}],184:[function(require,module,exports){
"use strict";
...
const TabsTemplate = require('Tabs.mustache');

const I18n = require('content/Models/I18n');

const urlClassification = require('content/Models/URLClassification').getInstance();
/**
 *  Responsible for rendering the tabs to choose between privacy and safety informations
 */


class BaseTabs extends View.extend({
  el: '#tabs',
  ...
  beforeRender() {
    ...
    const sections = this.getSections(unsafe).map(section => ({
      name: section.path,
      title: i18n[section.localizationKey],
      active: fragment === section.path,
      elementId: section.path.replace('/', '_')
    }));
    return {
      sections
    };
  ...
  getSections(unsafe) {
    ...
    if (unsafe) {
      sections.push({
        path: 'dash/security',
        localizationKey: 'lb_tab_security'
      }, {
        path: 'dash/privacy',
        localizationKey: 'lb_tab_privacy'
      });
    }
...
},{"Tabs.mustache":110,"backbone":19,"content/Models/I18n":128,"content/Models/URLClassification":133,"content/core/Views/View":149}],185:[function(require,module,exports){
"use strict";

const TransitionStrategy = require('content/core/Routing/AreasManagement/ViewTransitionStrategy');

const Default = require('content/Transitions/Default');

const PageTransition = require('popup/Transitions/PageTransition');

class PopupTransitionStrategy extends TransitionStrategy {}

PopupTransitionStrategy.prototype._transitionList = {
  Default,
  PageTransition
};
module.exports = PopupTransitionStrategy;

},{"content/Transitions/Default":136,"content/core/Routing/AreasManagement/ViewTransitionStrategy":145,"popup/Transitions/PageTransition":168}],186:[function(require,module,exports){
"use strict";

const Router = require('popup/Router');

module.exports = function getRouter() {
  return Router.getInstance();
};

},{"popup/Router":167}],187:[function(require,module,exports){
"use strict";
...
const AdguardModel = require('popup/Models/Adguard');

const SettingsModel = require('content/Models/Settings');

module.exports = function init() {
  return Promise.all([TabModel.getInstance().fetch(), AdguardModel.getInstance().fetch(), SettingsModel.getInstance().fetch()]);
};

},{"content/Models/Settings":131,"core-js/modules/es6.array.iterator.js":66,"core-js/modules/web.dom.iterable.js":67,"popup/Models/Adguard":165,"popup/Models/Tab":166}],188:[function(require,module,exports){
"use strict";
