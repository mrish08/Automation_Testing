...
},{"jquery":"jquery","underscore":17}],11:[function(require,module,exports){
"use strict";
...
},{"./ContentTopic":13,"./Messenger":14,"./chrome":16,"@babel/runtime/helpers/assertThisInitialized":1,"@babel/runtime/helpers/classCallCheck":2,"@babel/runtime/helpers/createClass":3,"@babel/runtime/helpers/getPrototypeOf":4,"@babel/runtime/helpers/inherits":5,"@babel/runtime/helpers/interopRequireDefault":6,"@babel/runtime/helpers/possibleConstructorReturn":7}],13:[function(require,module,exports){
"use strict";
...
},{"./Topic":15,"./chrome":16,"@babel/runtime/helpers/classCallCheck":2,"@babel/runtime/helpers/getPrototypeOf":4,"@babel/runtime/helpers/inherits":5,"@babel/runtime/helpers/interopRequireDefault":6,"@babel/runtime/helpers/possibleConstructorReturn":7}],14:[function(require,module,exports){
"use strict";
...
},{"@babel/runtime/helpers/classCallCheck":2,"@babel/runtime/helpers/createClass":3,"@babel/runtime/helpers/interopRequireDefault":6}],15:[function(require,module,exports){
"use strict";
...
},{"@babel/runtime/helpers/classCallCheck":2,"@babel/runtime/helpers/createClass":3,"@babel/runtime/helpers/interopRequireDefault":6}],16:[function(require,module,exports){
"use strict";
...
},{"content/Models/base/Settings":19}],19:[function(require,module,exports){
"use strict";
...
},{"backbone":10,"content/messagingInterface":21,"jquery":"jquery","underscore":17}],20:[function(require,module,exports){
"use strict";
...
const enableDataCollectionLink = $('#enableDataCollection');
const cancelDataCollectionLink = $('#cancelDataCollection');
const enableOffersLink = $('#enablePriceComparison');
const cancelOffersLink = $('#cancelPriceComparison');
const consentDataCollectionCard = $('#data-collection-status');
const consentOffersCard = $('#price-comparison-status');
const settingsModel = SettingsModel.getInstance();

const _toggleProp = (name, val) => {
  settingsModel.set(name, val);
  settingsModel.save();
};

enableDataCollectionLink.on('click', () => {
  _toggleProp('inAppTracking', true);

  consentDataCollectionCard.addClass('enabled');
});
cancelDataCollectionLink.on('click', () => {
  _toggleProp('inAppTracking', false);

  consentDataCollectionCard.addClass('canceled');
});
enableOffersLink.on('click', () => {
  _toggleProp('offers', true);

  consentOffersCard.addClass('enabled');
});
cancelOffersLink.on('click', () => {
  _toggleProp('offers', false);

  consentOffersCard.addClass('canceled');
});

},{"content/Models/Settings":18,"jquery":"jquery"}],21:[function(require,module,exports){
"use strict";
