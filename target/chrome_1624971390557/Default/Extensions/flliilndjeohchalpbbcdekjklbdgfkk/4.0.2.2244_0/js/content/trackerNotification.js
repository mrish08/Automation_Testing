...
const TrackerNotificationTemplate = require('TrackerNotification.mustache');
...
function openShare(e) {
  ...
  const shareUrl = encodeURIComponent(this.dataset.url);
  ...
  if (target === 'twitter') {
    height = 261;
    link = `https://twitter.com/share?url=${shareUrl}&text=${text}`;
  } else if (target === 'facebook') {
    link = `https://www.facebook.com/sharer/sharer.php?u=${shareUrl}&description=${text}`;
  }

  mixpanel.track('Notification - Share', {
    'notification type': 'Tracker Amount',
    'tracker amount': threshold,
    platform: target
  });
...
i18nLoader.getLocaleStrings(i18nStrings => {
  const html = Mustache.render(TrackerNotificationTemplate, {
    threshold: Number(threshold).toLocaleString(),
    extName: extensionAccessor.getManifest().name
  }, i18nStrings);
  const notification = $('#trackerNotification').html(html);
  mixpanel.track('Notification - Shown', {
    'notification type': 'Tracker Amount',
    'tracker amount': threshold
  });
  notification.find('.sharer-link').click(openShare);
  notification.find('.menu__close').click(() => {
    mixpanel.track('Notification - Close', {
      'notification type': 'Tracker Amount',
      'tracker amount': threshold
    }, () => messenger.publish('closeTrackerNotification', {}));
  });
});
messenger.publish('Settings:get', 'dark_mode', value => {
  if (value.dark_mode) {
    $('#trackerNotification').addClass('theme-dark');
  }
});

},{"TrackerNotification.mustache":68,"browser_accessors/extensionAccessor":2,"content/i18n_loader":84,"content/messagingInterface":85,"content/mixpanel":86,"jquery":"jquery","mustache":"mustache"}],5:[function(require,module,exports){
...
},{"./ContentTopic":63,"./Messenger":64,"./chrome":66,"@babel/runtime/helpers/assertThisInitialized":5,"@babel/runtime/helpers/classCallCheck":6,"@babel/runtime/helpers/createClass":7,"@babel/runtime/helpers/getPrototypeOf":8,"@babel/runtime/helpers/inherits":9,"@babel/runtime/helpers/interopRequireDefault":10,"@babel/runtime/helpers/possibleConstructorReturn":11}],63:[function(require,module,exports){
"use strict";
...
},{"./Topic":65,"./chrome":66,"@babel/runtime/helpers/classCallCheck":6,"@babel/runtime/helpers/getPrototypeOf":8,"@babel/runtime/helpers/inherits":9,"@babel/runtime/helpers/interopRequireDefault":10,"@babel/runtime/helpers/possibleConstructorReturn":11}],64:[function(require,module,exports){
"use strict";
...
},{"@babel/runtime/helpers/classCallCheck":6,"@babel/runtime/helpers/createClass":7,"@babel/runtime/helpers/interopRequireDefault":10}],65:[function(require,module,exports){
"use strict";
...
},{"@babel/runtime/helpers/classCallCheck":6,"@babel/runtime/helpers/createClass":7,"@babel/runtime/helpers/interopRequireDefault":10}],66:[function(require,module,exports){
"use strict";
...
module.exports = "<div class=\"box animate animate--d1\">\n  <ul id=\"menu\" class=\"menu\">\n    <li class=\"menu__item menu__close\"><img src=\"/img/abs-menu-close.png\" alt=\"\"></li>\n  </ul>\n  <header class=\"header\">\n  <div class=\"topbar\">\n    <div class=\"head__name\">\n    <div class=\"logo\">\n      <img src=\"/img/avira_icon48.png\" alt=\"\">\n      </div>\n    <h3>{{ extName }}</h3>\n  </div>\n  </header>\n\n  <div class=\"section ptl\">\n    <div class=\"mbs\">\n      <div class=\"milestone__medal animate animate--d2\">\n        <img class=\"db mla mra\" src=\"/img/tracker-milestone-medal.svg\">\n      </div>\n      <img class=\"milestone__confetti animate animate--d7 db\" src=\"/img/tracker-milestone-confetti.png\">\n    </div>\n    <div class=\"animate animate--d4 txt--lh-medium\">\n      <p class=\"txt--center txt--l txt--congrats\">{{> lb_congratulations }}</p>\n      <p class=\"txt--center txt--m txt--lead txt--osans\">{{> lb_trackers_blocked_count }}</p>\n      <p class=\"txt--center txt--m txt--lead txt--osans prm plm mbm\">{{> lb_trackers_milestone_subtitle }}</p>\n      <p class=\"flex flex--sb\">\n        <button\n          data-target=\"twitter\"\n          data-url=\"{{> lb_tracker_notification_share_url_twitter }}\"\n          data-text=\"{{> lb_trackers_twitter_share }}\"\n          class=\"sharer-link button button--white txt--twitter prxs plxs flex--g1 flex--b0 mrs db animate animate--d5\">\n          <div class=\"media\">\n              <img src=\"/img/icon-twitter.svg\" alt=\"Twitter\">\n          </div>\n        </button>\n        <button\n          data-target=\"facebook\"\n          data-url=\"{{> lb_tracker_notification_share_url_facebook }}\"\n          data-text=\"{{> lb_trackers_facebook_share }}\"\n          class=\"sharer-link button button--white txt--facebook prxs plxs flex--g1 flex--b0 db animate animate--d6\">\n          <div class=\"media\">\n              <img src=\"/img/icon-facebook.svg\" alt=\"Facebook\">\n          </div>\n        </button>\n      </p>\n    </div>\n  </div>\n</div>\n";
...
},{"core-js/modules/es6.array.iterator.js":59,"core-js/modules/web.dom.iterable.js":60}],82:[function(require,module,exports){
"use strict";
...
},{"i18n/de-DE":69,"i18n/en-US":70,"i18n/es-ES":71,"i18n/fr-FR":72,"i18n/it-IT":73,"i18n/ja-JP":74,"i18n/nl-NL":75,"i18n/pt-BR":76,"i18n/ru-RU":77,"i18n/tr-TR":78,"i18n/zh-CN":79,"i18n/zh-TW":80}],83:[function(require,module,exports){
"use strict";
...
},{"background/localStorage":1,"configuration":3,"underscore":67}],84:[function(require,module,exports){
"use strict";
...
},{"Locale":81,"Locales":82,"config":83,"content/messagingInterface":85,"underscore":67}],85:[function(require,module,exports){
"use strict";
...
},{"messenger/Content":61}],86:[function(require,module,exports){
"use strict";
...
},{"content/messagingInterface":85}]},{},[4]);
